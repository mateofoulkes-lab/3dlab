const CACHE='3dlab-mesh-to-cad-v4.0';
const SHELL=['./','./index.html','./styles.css','./app.js','./mesh-worker.js','./legacy-worker.js','./rebuild-worker.js','./manifest.webmanifest','./icons/icon.svg'];
